...
class Iso20022ParserClient:
    """Official zero-dependency client for ISO 20022 Financial Message Parser & Validator."""
    ...
    def __init__(
        ...
        self.tier = tier
        self.base_url = (base_url or "https://api.stanzaapi.com/iso20022-parser").rstrip("/")
        self.validate_endpoint = "/api/v1/validate"
        self.parse_endpoint = "/api/v1/parse"
        self.timeout = timeout
        self.tool_url = "https://stanzaapi.com/tools/iso20022-parser"
    ...
    def _request(self, endpoint: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        headers = {
            ...
            "User-Agent": "stanzaapi-iso20022-parser-python/1.0.0"
        }
        if self.api_key:
    ...
    def validate(self, payload: Any) -> Dict[str, Any]:
        ...
        body = {"xml": payload} if isinstance(payload, str) else payload
